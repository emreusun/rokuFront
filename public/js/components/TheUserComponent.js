export default {
    ...
    methods:{
        NavToHome(){
            ...
            // if it's less than 3, sned them to the kid's home page
        ...
        // ternary statments (wird stuff like this with a question mark) are shorthand if/else statments
        // the conditios in brackets is evaluated; if it's trues, the variable's value is set to whatever is so to the left of the colon
